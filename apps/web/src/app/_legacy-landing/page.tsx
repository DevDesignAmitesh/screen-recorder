...
// Backed up verbatim from the old app/page.tsx (the marketing landing page)
// when the product was cut down to a single record-and-download flow at
// "/". Kept here, unrouted (underscore-prefixed folders are excluded from
// Next.js routing), so nothing is lost and this is trivially restorable —
// see the plan notes around that change for context.
